...
Route::group(['prefix' => 'admin', 'middleware' => ['role:super']], function(){
    ...
    Route::get('users-kopidik', App\Http\Controllers\Admin\UserKopidik::class)->name('admin.users.kopidik');
    //Kesiswaan
    ...
    //Setting
    Route::get('statistik-peserta-didik', App\Http\Controllers\Admin\StatistikPesertaDidik::class)->name('admin.statistik.serdik');
